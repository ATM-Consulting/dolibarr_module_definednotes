 ...
 */
class definednotesbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "definednotes@definednotes";
    public $boxlabel;
    public $depends = array("definednotes");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/definednotes/class/definednotes.class.php";
